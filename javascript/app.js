...
const translations = {
  en: {
    ...
    welcome_subtitle:
      "Challenge your mind with strategic logic puzzles. Test your reasoning, pattern recognition, and analytical thinking.",
    btn_start: "Start",
  ...
  uz: {
    ...
    welcome_subtitle:
      "Strategik mantiq boshqotirmalariga yo'n nazaringizni buling. Mantiqiy fikrlash, naqsh tanish va analitik fikrlashni sinovdan o'tkazing.",
    btn_start: "Boshlash",
  ...
  ru: {
    ...
    welcome_subtitle:
      "Проверьте свой ум с помощью стратегических логических головоломок. Протестируйте свое рассуждение, распознавание закономерностей и аналитическое мышление.",
    btn_start: "Начать",
...
function initializeTest() {
  ...
  appState.questions = shuffleArray(allQuestions).slice(
    0,
    appState.numQuestions,
  );
...
function submitAnswer(selectedButtonElement) {
  ...
  const isCorrect =
    selectedButtonElement.getAttribute("data-correct") === "true";
